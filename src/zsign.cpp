...
int usage()
{
	...
	ZLog::Print("-x, --deletemp\t\tExclude provisioning profile from the bundle.\n");
...
int main(int argc, char* argv[])
{
	...
	atimer.Reset();
	ZBundle bundle;
	bool bRet = bundle.SignFolder(&zsa, strFolder, strBundleId, strBundleVersion, strDisplayName, arrDylibFiles, bForce, bWeakInject, bExcludeProvisioning, bEnableCache);
	atimer.PrintResult(bRet, ">>> Signed %s!", bRet ? "OK" : "Failed");
